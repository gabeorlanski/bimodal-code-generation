...
class CerberusAlabasterParser(TutorialHTMLParser):
    NAME = "cerberus"
...
@TutorialHTMLParser.register('pint')
@TutorialHTMLParser.register('arrow')
@TutorialHTMLParser.register('yarl')
@TutorialHTMLParser.register('bleach')
class AlabasterBleachParser(TutorialHTMLParser):
    NAME = "AlabasterBleachParser"
